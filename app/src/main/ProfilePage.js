              ...
              <div className='profile-container'>
                ...
                <div className='profile-details'>
                  ...
                  { editMode ? 
                            ...
                            : 
                              <div className='profile-details__bio'>{profile.bio}</div> 
                  }
                  { editMode ? 
                  ...
                  { editMode ? 
                            ...
                            : 
                              <div className='profile-details__contact'>{profile.contactNumber}</div> 
                  }
                  { editMode ? 
                            ...
                            : 
                              <div className='profile-details__address'>{profile.address}</div> 
                  }
                  { editMode ? 
                            ...
                            : 
                              <div className='profile-details__city'>{profile.city}</div> 
                  }
                  { editMode ? 
                            ...
                            : 
                              <div className='profile-details__state'>{profile.state}</div> 
                  }
                  { editMode ? 
                            ...
                            : 
                              <div className='profile-details__zipcode'>{profile.zipCode}</div> 
                  }
                  { editMode ? 
                            ...
                            : 
                              <div className='profile-details__country'>{profile.country}</div> 
                  }
                </div>
              </div>
